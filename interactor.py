...
class Interactor(nn.Module):
    ...
    def forward(self, x):
        ...
        output1 = torch.matmul(left_transposer.permute(0,2,1), x)
        right_transposer = self.column_wise_nn2(output1)
        output = torch.matmul(output1, right_transposer.permute(0,2,1))
